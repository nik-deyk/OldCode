### see comments under https://www.youtube.com/watch?v=mdJdB7On4AM&t=1748s
...
def solve(k1, m, k2, p2, n2) -> tuple:
    if n2 > m:
        ...
        if k1 > k2:
            return (1 if k1 <= m else 0, 1 if m == 1 else 0)
        else:
            return (p2, n2)
    else:
        return decision_2(k1, m, k2, p2, n2)